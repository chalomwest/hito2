	...
	<div class="container">
		<div class="main row">
			<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
				...
				<a href="massu1.php" class="btn btn-primary">Cancha #1</a>
				<a href="massu2.php" class="btn btn-success">Cancha #2</a>
				<a href="massu3.php" class="btn btn-danger">Cancha #3</a>
				<a href="massu4.php" class="btn btn-info active">Cancha #4</a>
					<!--Inicia Tabla -->
						...
						<tr>
							...
							<td>
								<FORM>
										...
										onclick='alert("Valor= $1000.")' value="Disponible" />
									</FORM>
							</td>
							<td>
								<FORM>
