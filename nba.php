	...
	<div class="container">
		<div class="main row">
			<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
				<p>
					<h3>Recinto NBA</h3>
					<p>Sin duda el recinto deportivo mas grande que tenemos. Contamos con canchas de basquet y volley de ultimo nivel.<br/><br/>
			...
			<aside class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
					...
					<h3>Recintos</h3>
							...
							<a href="nba.php" class="list-group-item active">NBA</a>
					</div>
