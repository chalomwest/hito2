	...
	<div class="container">
		<div class="main row">
			<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
				<p>
					<h3>Recinto EL PHELPS</h3>
					<p>Dicen que es el deporte mas lindo del mundo y claro, puedes practicarlo con nosotros! Contamos con una piscina olímpica de gran nivel.<br/><br/>
					<img src="piscina.jpg" class="img-responsive" alt="Imagen de la piscina">
					</p>
					</br>
			...
			<aside class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
					...
					<h3>Recintos</h3>
							...
							<a href="phelps.php" class="list-group-item active">El Phelps</a>
